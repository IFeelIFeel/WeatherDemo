...
import com.zqy.weatherdemo.gson.Forecast;
import com.zqy.weatherdemo.gson.Weather;
import com.zqy.weatherdemo.service.AutoUpdateService;
        ...
        HttpUtil.sendOkHttpRequest(weatherUrl, new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        ToastUtils.showShort(WeatherActivity.this, "获取天气信息失败");
